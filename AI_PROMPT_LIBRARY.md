# AI Prompt Library for Product Development (Quickstart → Launch → Grow)
...
Copy the prompt text and paste it into your AI assistant. Replace any placeholder text (indicated with [brackets]) with your specific details.

---

## Navegação rápida
- **QUICKSTART (3 passos):** Quickstart Context → Build Kick-off → Start Building Command
- **VALIDATE:** entrevistas, segmentos, JTBD, Lean Canvas, Value Proposition
- **PLAN:** story map, PRD, MoSCoW, tech stack, roadmap/marcos, visão & estratégia
- **BUILD:** design system starter, repo+CI/CD, arquitetura, feature plan, testes
- **LAUNCH:** landing page copy, pricing page, FAQ, launch checklist + rollback
- **GROW & ITERATE:** growth experiments, retrospective, KPI dashboard

---

## QUICKSTART (3 passos)

### 1) Quickstart Context Co-Pilot

**Purpose:**
To have an AI co-pilot guide you in rapidly defining the essential foundational context for your new product idea.
...
Please guide me through the following sections **one by one, or in small, logical groups**. **Wait for my response** to each group before moving on. Use my initial thoughts to ask clarifying questions and help me elaborate.

After all sections, compile a structured summary.
...
> Their needs/characteristics are: [ e.g., want to learn new things, save money, or connect with community ]
...
*My Initial Thoughts (User to customise):*  
> I like the feel of it being: [ e.g., friendly and approachable, minimal, playful, elegant, utilitarian ]  
...
"You are an expert Product Development Co-Pilot. Your goal is to help me create a 'Build Kick-off Plan' for my product idea using the 'Quickstart Context' (which I will provide) as our foundation.
...
### 3) Start Building Command (Iterative, Task-by-Task)

**Purpose:**
To generate a precise initial command or set of instructions to give to an AI building tool to kickstart the development of your Day 1 prototype.

**Goal:**
A ready-to-use, focused command for an AI development tool, incorporating your context, MVP plan, and guardrails to guide the initial build.

**When to Use:**
After creating your 'Build Kick-off Plan,' when you're ready to give the very first instruction to an AI tool to start generating code for your prototype.
...
- The target audience
- My hypotheses about pain points
...
### 8) Value Proposition Canvas Generator
...
### 10) PRD Generator (Product Requirements Document)
...
### 11) Must-Should-Could Prioritizer (MoSCoW)
...
### 13) Roadmap Milestone Planner (MVP → Scale)
...
### 14) Product Vision & Strategy Outline
...
## BUILD (setup → arquitetura → entrega → qualidade)

### 15) Design System Starter
...
### 16) Repo & CI/CD Quick-start (GitHub)
...
### 18) Feature Implementation Planner
...
### 19) Testing Strategy (Pyramid + CI)
...
## Launch Prompts (copy → pricing → confiança → rollback)

### 20) Landing Page Copy Crafter
...
### 22) Objection-Handling FAQ Builder
...
### 23) Launch Checklist & Roll-back Plan
...
## Grow Prompts (experimentar → medir → iterar)

### 24) Growth Experiment Generator
...
### 25) Retrospective Facilitator (Start/Stop/Continue)
